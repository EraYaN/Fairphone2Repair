...
This unit was chosen to be the amount of CO\subscript{2} emissions (in grams) per gram of product that needs to be transported.
...
The shipping by plane would result in an eco-impact of \SI{4.16}{\gram} of CO\subscript{2} per g of product being shipped.
The shipping by containership would result in an eco-impact of \SI{0.44}{\gram} of CO\subscript{2} per g of product.
