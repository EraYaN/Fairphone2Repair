...
Of course it can then also optimise for the lowest eco impact.
If the user is near a Trusted Distributor (see Chapter \ref{ch:trusted-distributors}) they can go and pick the part up, the store will tell them where the TD is and how to get there.
If there is no stock near we can either restock a TD in the vicinity or ship the part directly to the customer.
